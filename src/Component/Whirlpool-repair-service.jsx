...
<h1 className="color-blue pt-2">Whirlpool</h1>
...
<p className="sub_content pt-2 pb-2">If you have any Whirlpool   product and are looking for Whirlpool   Product
 Service Centre in your city then you have come to the right place. Customer Home Services provides 
...
<p className="sub_content">We have technicians with good experience in servicing & repairing your products.
 Customer Home Services provides you efficient and effective services. Our Regesitered Service center provides
...
<p className="content_text">Customer Home Service care helps you in providing
...
<p className="content_text">Customer Home Service helps you in providing Registered
...
best repair and service at your doorstep in your city.We are Warranty Service providers.</p>

<p className="content_head_text pt-4 margin-0">DISHWASHER REPAIR & SERVICE</p>
<p className="content_text">Customer Home Service helps you in providing Registered Service Centre for your Dishwasher. We 
provide best repair and service at your doorstep in your city. We are Warranty Service providers.</p>


<p className="content_head_text pt-4 margin-0">TV REPAIR & SERVICE</p>
<p className="content_text">Customer Home Service helps you in providing
 Registered Service Centre for your LED/LCD. We provide best repair 
and service at your doorstep in your city. We are Warranty Service providers.</p>
    </div>
